...
"vs market" calculation is also correct by design — since the DP schedules `required_hours + retained_hours` as a single combined requirement, the avg price covers all scheduled slots together. No special handling needed.
