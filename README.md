...
431 tests across five files. Run from the repo root:
...
```
PYTHONPATH=.:test:delivery python -m unittest test_charging_planner -v       # 291 tests, 3 skipped
...
## test_charging_planner.py (291 tests)
